...
import { ArrowLeft, Send, Image as ImageIcon, Type, FileText, X } from "lucide-react";
...
export default function NewBlogPostPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      let finalImageUrl = "/blog/default.jpg";

      // 1. Client-side upload to bypass 4.5MB Vercel limit
      if (selectedFile) {
        try {
      ...
      // 2. Clear image from formData as we already uploaded it
      formData.delete("image");
      // Add the final URL instead
      ...
      setError(err.message || "Verbindung zum Server fehlgeschlagen oder Zeitüberschreitung.");
      setIsPending(false);
    }
  }
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-12">
      <div className="flex flex-col gap-6">
        ...
        <h1 className="text-4xl font-black text-secondary italic uppercase mb-2">Neuer <span className="text-primary">Beitrag.</span></h1>
      </div>
        ...
        <form onSubmit={handleSubmit} className="relative z-10 space-y-10">
          <div className="flex flex-col gap-3">
            ...
            <input 
              ...
              name="title" 
              type="text" 
              placeholder="z. B. Die Marktentwicklung im Bergischen Land 2024" 
          ...
          <div className="flex flex-col gap-3">
            <label className="text-xs font-black uppercase tracking-widest text-secondary flex items-center gap-2">
              <ImageIcon size={16} className="text-primary" /> Titelbild
            </label>
               ...
               {imagePreview ? (
                  ...
                  <div className="flex flex-col items-center gap-6 text-slate-400 p-10 text-center">
                     ...
                     <div className="space-y-1">
                        <p className="text-xs font-black uppercase tracking-widest text-secondary">Bild auswählen</p>
          ...
          <div className="flex items-center gap-8 bg-slate-50 p-8 rounded-3xl border border-slate-100">
             <label className="flex items-center gap-4 cursor-pointer group">
                ...
                />
                <span className="text-sm font-black text-secondary uppercase italic group-hover:text-primary transition-colors">Beitrag sofort veröfentlichen</span>
             </label>
          </div>
          ...
          >
            <Send size={24} /> {isPending ? "Wird verarbeitet..." : "Beitrag jetzt veröffentlichen"}
          </button>
        </form>
      </div>
    </div>
