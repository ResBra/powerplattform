...
export default function GroupPage() {
   ...
   if (!group || !user) {
      return (
         <div className="min-h-screen bg-[#050a10] flex items-center justify-center p-6 text-center font-black animate-pulse opacity-10 uppercase tracking-widest text-foreground">
            Authorizing Access Network...
         </div>
      );
   }
