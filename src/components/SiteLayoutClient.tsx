    ...
    <div className="flex min-h-screen transition-colors duration-300">
      ...
      <header className="lg:hidden h-20 bg-black fixed top-0 inset-x-0 z-[110] flex items-center justify-between px-6 border-b border-white/5 shadow-xl">
         ...
         <div className="flex gap-2">
            <button onClick={() => setIsSettingsOpen(true)} className="p-3 bg-foreground/5 rounded-2xl text-foreground/70"><Settings size={20} /></button>
            <button onClick={() => setIsOpen(true)} className="p-3 bg-foreground/10 rounded-2xl text-foreground"><Menu size={24} /></button>
         </div>
      </header>
